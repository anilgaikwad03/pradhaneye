    ...
    <div class="container mx-auto">
      <div class="grid max-sm:grid-cols-1 max-xl:grid-cols-2 xl:grid-cols-5 gap-8 max-w-7xl mx-auto">
        ...
        <div class="text-white">
          ...
          <ul class="space-y-4">
            <li><a href="./services/lasik.html" class="hover:text-accent flex items-center gap-2"><svg
            ...
            <li><a href="./services/cataract.html"
            ...
            <li><a href="./services/squint.html" class="hover:text-accent flex items-center gap-2"><svg
                  xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[10px] -rotate-90"
                  viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
                    d="M11.99997 18.1669a2.38 2.38 0 0 1-1.68266-.69733l-9.52-9.52a2.38 2.38 0 1 1 3.36532-3.36532l7.83734 7.83734 7.83734-7.83734a2.38 2.38 0 1 1 3.36532 3.36532l-9.52 9.52a2.38 2.38 0 0 1-1.68266.69734z">
            ...
            <li><a href="./services/retina.html" class="hover:text-accent flex items-center gap-2"><svg
                  xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-[10px] -rotate-90"
                  viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
                    d="M11.99997 18.1669a2.38 2.38 0 0 1-1.68266-.69733l-9.52-9.52a2.38 2.38 0 1 1 3.36532-3.36532l7.83734 7.83734 7.83734-7.83734a2.38 2.38 0 1 1 3.36532 3.36532l-9.52 9.52a2.38 2.38 0 0 1-1.68266.69734z">
